...
class MyArticle1 extends StatefulWidget {
  const MyArticle1({super.key, required article});

  @override
  State<MyArticle1> createState() => _MyArticle1State();
}

class _MyArticle1State extends State<MyArticle1> {
  bool isLiked = false;
