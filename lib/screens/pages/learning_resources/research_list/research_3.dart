...
class Research3 extends StatefulWidget {
  const Research3({super.key});

  @override
  State<Research3> createState() => _Research3State();
}

class _Research3State extends State<Research3> {
  bool isLiked = false;
